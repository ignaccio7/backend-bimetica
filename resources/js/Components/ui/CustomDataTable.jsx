...
export default function CustomDataTable({
    ...
    const obtenerEstilosFila = (filaIndex, fila) => {
        const estilosBase =
            filaIndex % 2 === 0 ? "bg-white-100" : "bg-gray-200";
                        ...
                        <div className="block md:hidden">
                            {contenidoTabla.map((fila, filaIndex) => (
                                <div
                                    ...
                                    className={`p-4 border-b border-gray-200  last:border-b-0 ${obtenerEstilosFila(
                                        filaIndex,
                                        fila
                                    )}`}
                                >
